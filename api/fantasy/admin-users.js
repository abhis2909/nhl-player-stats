...
/* /api/fantasy/admin-users — admin-only, the Users sub-tab on
   ...
   avatar and any pending avatar-change request (avatarRequestUrl/
   ...
   request actually gets submitted). Never returns passwordHash itself,
   just a derived "setUp" boolean (whether the person has logged in and
   picked a password yet).
